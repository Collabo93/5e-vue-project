public class BackgroundsData5 implements BackgroundsData {
	...
	private String[] languages = { "Auran" };
	private String[] equipment = { "a pair of Aviator's Goggles",
			"a set of clothing custom-tailored for the purpose of flight safetys", "a pouch containing 10gp" };
	private int descChoose = 1;
	private String[] descNames = { "Unmatched Flight" };
	private String[] desc = {
